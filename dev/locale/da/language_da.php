...
$additional_information = [
    "chest-hair-natural" => [
        "label" => "Natürlich",
        "description" => "Die Haare sind völlig unberührt und wachsen frei."
    ],
    "chest-hair-trimmed" => [
        "label" => "Gestutzt",
        "description" => "Die Haare wurden bewusst gekürzt oder geformt (z. B. mit Schere oder Trimmer), aber nicht vollständig entfernt."
    ],
    "chest-hair-hairless" => [
        "label" => "Haarlos",
        "description" => "Der Bereich ist vollständig oder nahezu haarlos – z. B. durch Rasur, Wachs, Laser oder Ähnliches. Leichter Stoppelwuchs zählt ebenfalls als haarlos."
    ],
    ...
    "marks-none" => [
        "label" => "Keine Dehnungsstreifen oder Narben",
        "description" => null
    ],
    "marks-stretch" => [
        "label" => "Dehnungsstreifen",
        "description" => null
    ],
    "marks-scars" => [
        "label" => "Narben",
    ...
    "tattoos-breasts" => [
        "label" => "Tätowierungen auf der Brust",
        "description" => null
    ],
    "tattoos-vulva" => [
        "label" => "Tätowierungen an der Vulva",
        "description" => null
    ],
    "tattoos-penis" => [
        "label" => "Tätowierungen am Penis",
        "description" => null
    ],
    "tattoos-buttocks" => [
        "label" => "Tätowierungen am Gesäß",
        "description" => null
    ],
    "tattoos-other" => [
        "label" => "Andere Tattoos",
        "description" => null
    ],
...
$additional_information = [
    "chest-hair-natural" => [
        "label" => "Naturlig",
        "description" => "Håret er helt uberørt og får lov at vokse frit."
    ],
    "chest-hair-trimmed" => [
        "label" => "Trimmet",
        "description" => "Håret er bevidst klippet eller formet (fx med saks eller trimmer), men ikke fjernet helt."
    ],
    "chest-hair-hairless" => [
        "label" => "Hårløs",
        "description" => "Området er helt eller næsten uden hår – fx ved barbering, voks, laser eller lignende. Let stub tæller stadig som hårløs."
    ],
    "genital-hair-above-natural" => [
        "label" => "Naturlig",
        "description" => "Håret er helt uberørt og får lov at vokse frit."
    ...
    "marks-none" => [
        "label" => "Ingen strækmærker eller ar",
        "description" => null
    ],
    "marks-stretch" => [
        "label" => "Strækmærker",
    ...
    "tattoos-false" => [
        "label" => "Ingen tatoveringer",
        "description" => null
    ],
    "tattoos-breasts" => [
        "label" => "Tatoveringer på brystet",
        "description" => null
    ],
    "tattoos-vulva" => [
        "label" => "Tatoveringer på vulva",
        "description" => null
    ],
    "tattoos-penis" => [
        "label" => "Tatoveringer på penis",
        "description" => null
    ],
    "tattoos-buttocks" => [
        "label" => "Tatoveringer på balder",
        "description" => null
    ],
    "tattoos-other" => [
        "label" => "Andre tatoveringer",
        "description" => null
    ],
    "hormonal-influence-true" => [
        "label" => "Ja",
